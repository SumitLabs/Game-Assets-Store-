...
const Nav = () => {
    ...
    return (
      <div className="modal_overlay">
        ...
        >
          ...
          <div className="auth flex_box justify_between">
            <div className="left_auth  flex_box justify_center align_center flex_col">
              ...
              <div className="toggle_form">
                {sign === "Sign In" ? <h2>Come join us!</h2> : <h2>Nice to meet you again!</h2>}
                {sign === "Sign In" ? (
                  <p>
                ...
                {sign === "Sign In" ? (
                  <h2 onClick={() => setSign("Sign Up")}>  Don’t have an account? Sign Up</h2>
                ) : (
                  <h2 onClick={() => setSign("Sign In")}>
  ...
  return (
    <nav className="navbar flex_box align_center justify_evenly container">
      <div className="logo">
        <Link to="/">
          <h2>NovaAsset</h2>
        </Link>
